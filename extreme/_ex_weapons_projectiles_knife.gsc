		...
		if(trace["fraction"] != 1)
		{
			...
			if(!ignore_entity)
			{
				...
				if(knife_action == 1)
				{
					...
					//extreme\_ex_main_utils::debugAngles(trace["position"], vectorNormalize(neworigin - knife.origin), undefined);
				...
				else if(knife_action == 2)
				{
					...
					//extreme\_ex_main_utils::debugAngles(trace["position"], vOldDirection, vNewDirection);
					knife_bouncing = true;
					continue;
				}
				// delete
