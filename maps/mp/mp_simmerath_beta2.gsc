...
//delete axis spawns too far away from axis flag
extreme\_ex_spawnpoints::deleteSpawnPoint( (6496, -1032, -138) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7104, -1016, -138) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7016, -232, -140) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7576, -240, -98) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7770, -486, -98) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7752, 32, -100) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7612, 402, -92) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (7236, 658, -142) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (6966, 408, -138) );
extreme\_ex_spawnpoints::deleteSpawnPoint( (6036, 912, -212) );
